...
const cookieExtractor = req => {
    ...
    if (req && req.cookies) { // validamos que existan cookies en la request
        console.log("Cookies recibidas en cookieExtractor condicion:");
        token = req.cookies['jwtCookieToken'];
        console.log("Token encontrado en cookieExtractor:");
        console.log(token);
    }
